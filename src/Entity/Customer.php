...
class Customer
{
     ...
     * @Assert\Email(message="Le format d'adresse email doit etre valide")
     */
    private $email;
     ...
     * @Groups({"customers_read"})
     * @Assert\NotBlank(message="L'utiliateur est obligatoire")
     */
    private $user;
    ...
    /**
     * Permet d'avoir le total des invoices
     * @Groups({"customers_read"})
     *
     * @return float
     */
